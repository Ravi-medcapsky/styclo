  ...
  return (
    ...
    >
      ...
      <div className=" flex flex-col items-center w-full  h-[80%] justify-center  lg:max-w-[40%] max-w-[90%] shadow-[0_8px_30px_rgba(0,0,0,0.08)]">
        <div
          className="bg-white backdrop-blur-3xl text-black flex flex-col items-center lg:pt-0  px-5  h-full w-full  justify-center   rounded-xl shadow-lg 
                                 lg:rounded-tr-none lg:rounded-br-none "
        >
          {/* Toogle Button */}
          <div className="relative flex h-15 my-5 border border-gray-300 rounded-full overflow-hidden w-full lg:w-[70%]">
            <button
              type="button"
          ...
          <form className="w-full h-full max-w-sm">
            ...
            <button
              type="button"
              className="w-full flex items-center justify-center gap-2 border border-gray-300 py-2 rounded hover:bg-gray-100 hover:text-gray-500 active:scale-[0.98] active:duration-75 transition-all duration-200"
            >
